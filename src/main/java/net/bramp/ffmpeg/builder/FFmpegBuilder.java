...
public class FFmpegBuilder {
  ...
  public FFmpegBuilder setCodec(String codec) {
    this.codec = checkNotNull(codec);
    return this;
  }

  public FFmpegBuilder setMap(int map) {
    this.map = map;
    return this;
  }

  public FFmpegBuilder setOutput(String output) {
    this.output = output;
    return this;
  }

  public FFmpegBuilder setSegmentTime(int segment_time) {
    this.segment_time = segment_time;
    return this;
  }

  public FFmpegBuilder setSegment(String segment) {
  ...
  public List<String> build() {
    ...
    if (map != null) {
      args.add("-map", Integer.toString(map));
    }

    if (segment_time != null) {
      args.add("-segment_time", Integer.toString(segment_time));
    }
